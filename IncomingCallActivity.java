...
public class IncomingCallActivity extends AppCompatActivity {
    ...
    ImageView profile_iv,recive_call_iv,close_call_iv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final int room_no = intent.getIntExtra("room_no",0);

        profile_iv = (ImageView)findViewById(R.id.profile_iv);
        recive_call_iv = (ImageView)findViewById(R.id.recive_call_iv);
        close_call_iv = (ImageView)findViewById(R.id.close_call_iv);
        nickname_tv = (TextView)findViewById(R.id.nickname_tv);


        close_call_iv.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        recive_call_iv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                connectToRoom(String.valueOf(room_no),false,false,false,0);
                finish();
            }
        });
